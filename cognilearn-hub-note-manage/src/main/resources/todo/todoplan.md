...
| 编号     | 用户行为 / 动作                    | 使用场景说明                                                                               |
| -------- | ---------------------------------- | ------------------------------------------------------------------------------------------ |
| 1/（v2） | 新建笔记                           | 用户点击“新建笔记”按钮，初始化空白笔记<br /><br /><br />指定模板笔记(指定模板笔记（v2）) |
...
| **策略模式（Strategy）** | 不同笔记存储策略（本地/MySQL + MinIO/分布式存储） |
| ------------------------ | ------------------------------------------------- |


| **工厂模式（Factory）** | 附件处理（图片、PDF、音频不同处理逻辑） |
| ----------------------- | --------------------------------------- |


| **模板方法模式（Template Method）** | 统一 CRUD 流程，方便扩展版本控制、操作日志 |
| ----------------------------------- | ------------------------------------------ |


| **装饰器模式（Decorator）** | 扩展笔记功能（加密、标签、权限控制） |
| --------------------------- | ------------------------------------ |
