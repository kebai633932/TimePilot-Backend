...
public class TokenServiceImpl implements ITokenService {
    ...
    public TokenPairDTO refreshToken(String refreshToken, String currentAccessToken) {
        ...
        // 4. 获取分布式锁（用户ID+设备ID）
        Long userId = refreshClaims.get("uid", Long.class);
    ...
    public void logout(String accessToken, String refreshToken) {
        try {
            ...
            // 3. 获取用户和设备信息
            Long userId = accessClaims.get("uid", Long.class);
    ...
    private void validateTokenConsistency(Claims claims1, Claims claims2) {
        Long uid1 = claims1.get("uid", Long.class);
        Long uid2 = claims2.get("uid", Long.class);
